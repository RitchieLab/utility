...
### logo_blue_gradient ------------------------------------------------------
#' @export
logo_pmbb <- shinyDashboardLogoDIY(
...
### theme_blue_gradient -----------------------------------------------------
#' @export
theme_pmbb <- shinyDashboardThemeDIY(
  ...
  ,dangerFontColor = "rgb(0,0,0)"
  ,bodyBackColor = "rgb(242,242,243)"
  
  ### header
  ,logoBackColor = "rgb(0,15,58)"
  ...
  ,boxShadowColor = "rgba(0,0,0,.1)"
  ,boxTitleSize = 16
  ,boxDefaultColor = "rgb(149,0,26)"
  ,boxPrimaryColor = "rgb(149,0,26)"
  ,boxInfoColor = "rgb(0,20,77)"
  ,boxSuccessColor = "rgb(64,186,170)"
  ,boxWarningColor = "rgb(149,0,26)"
